...
public class NarwhalNotifier extends Activity {
	...
	public class AccountEditListener implements OnClickListener {
		 ...
		 * 
		 * @param v
		 *            View clicked to call this method
		 */
		public void onClick(View v) {
			Intent accountActivity = new Intent(NarwhalNotifier.this,
					AccountEditor.class);
	...
	public class OptionsListener implements OnClickListener {
		 ...
		 */
		public void onClick(View v) {
			Intent optionsActivity = new Intent(NarwhalNotifier.this,
					Options.class);
	...
	/**
	 * Sets the subtext for the Edit Account view to show the username of the
	 * currently logged in user, or show that no user is logged in.
	 */
