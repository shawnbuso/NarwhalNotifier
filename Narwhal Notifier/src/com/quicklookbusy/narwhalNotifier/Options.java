...
public class Options extends Activity {
	 ...
	 * @version 1.0
	 */
	private class MessagesCheckListener implements CompoundButton.OnCheckedChangeListener {
		/**
		 * Updates settings when messages checkbox is changed
		 * @param buttonView The button clicked
		 * @param isChecked True if the button is checked, false otherwise
		 */
	 ...
	 * @version 1.0
	 */
	private class ModmailCheckListener implements CompoundButton.OnCheckedChangeListener {
		/**
		 * Updates settings when messages checkbox is changed
		 * @param buttonView The button clicked
		 * @param isChecked True if the button is checked, false otherwise
